...
public class ServiceSelectionController {
    ...
    private void loadServices() {
        ...
        for (Service service : services) {
            Button serviceButton = new Button(service.getName() + " - " + service.getPrice() + " Р");
    ...
    private void selectService(Service service, ActionEvent event) {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/client.Kholenko/master-selection.fxml"));
    ...
    private void goBack(ActionEvent event) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/client.Kholenko/main-view.fxml"));
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(new Scene(root));
        stage.show();
    }
