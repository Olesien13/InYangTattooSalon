...
import coursework.itms206.utils.EmailUtils;
...
public class LoginController {
    ...
    private void loginButton(ActionEvent event) {
        ...
        UserSession.start(user.getId(), user.getEmail(), user.getRole(), user.getDiscount(), user.getCompletedServicesCount());

        // определяем путь к fxml-файлу в зависимости от роли
        String fxmlPath = userAdmin ? "/admin.Shokina/menu.fxml" : "/client.Kholenko/main-view.fxml";
        try {
            ...
            stage.setOnCloseRequest(e -> UserSession.clear()); // при закрытии окна сбрасываем сессию
    ...
    private void goRegister(ActionEvent event) throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/client.Kholenko/register-view.fxml"));
