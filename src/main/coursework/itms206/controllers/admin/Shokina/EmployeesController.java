...
public class EmployeesController {
    ...
    private void addEmployee() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/admin.Shokina/add-employees.fxml"));
    ...
    private void editEmployee() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/admin.Shokina/change-employees.fxml"));
            Parent root = loader.load();
    ...
    private void showSchedule() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/admin.Shokina/schedule.fxml"));
